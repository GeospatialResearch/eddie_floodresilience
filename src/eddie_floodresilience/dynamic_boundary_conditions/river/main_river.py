...
def main(
    ...
    with engine.connect() as conn:
        ...
        river_data_to_from_db.store_rec_data_to_db(conn)
        # Get the REC river network for the catchment area
        _, rec_network_data = river_network_for_aoi.get_rec_river_network(conn, catchment_area)
        ...
        try:
            ...
            rec_inflows_data = river_inflows.get_rec_inflows_with_input_points(
                conn, catchment_area, rec_network_data, distance_m=300)
